...
/** Lien Axiom immédiat (sans appel réseau). */
export function axiomTradeUrlInstant(mint, pairAddress = '') {
  ...
  return `https://axiom.trade/meme/${encodeURIComponent(m)}?chain=sol`;
}
